...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="text-white flex flex-col text-center z-10 bg-gray-800/50 p-8 rounded-lg backdrop-blur-sm shadow-2xl w-full max-w-md">
        <div className="flex flex-col items-center justify-center gap-4 mb-4">
          <img src="/assets/bookOpen.svg" className="w-16 h-16 text-cyan-400" alt="book" />
